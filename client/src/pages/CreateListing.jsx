...
export default function CreateListing() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if(+formData.regularPrice < +formData.discountedPrice) return setError("discount price should be lower than regular price")
        ...
        <main className="p-3 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-wrap gap-6">
                    ...
                    {formData.offer && (
                        <div className="flex items-center gap-2">
                            <input onChange={handleChange} value={formData.discountedPrice} type="number" id="discountedPrice" min='0' max='10000000' required className="p-3 border border-gray-300 rounded-lg"/>
                            <div className="felx flex-col items-center">
